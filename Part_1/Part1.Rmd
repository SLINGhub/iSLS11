...
## 4. Prepare and convert to a long format table
...
## 11. Calculate quality-control (QC) value for each lipid
...
## 13. Inspect QC filtering results per lipid class
